...
;;  (setq org-startup-with-inline-images t)
  ...
  (setq org-agenda-files '("~/OneDriveWork/OrgFiles"))
  ...
  (with-eval-after-load 'org
    ...
    (add-to-list 'org-structure-template-alist '("pl" . "src plantuml :file TBD.png"))
